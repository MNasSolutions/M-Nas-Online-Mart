  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground hover:opacity-90 shadow-medium hover:shadow-strong transform hover:scale-105 font-semibold",
        cta: "bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-medium hover:shadow-strong transform hover:scale-105 font-semibold",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-soft hover:shadow-medium",
        premium: "gradient-primary text-primary-foreground hover:opacity-90 shadow-glow font-semibold tracking-wide",
      },
      size: {
